...
//public class GameEvents : GenericEventBus
//{
//    public static GameEvents CreateEventBus()
//    {
//        List<GameEventBase> events = new List<GameEventBase>
//        {
//            new GameEvent<BonusTokenData>()
//        };
//        return new GameEvents(events);
//    }

//    public GameEvents(List<GameEventBase> events) : base(events)
//    { }
...
//    public void AddListener(EGameEvent eventType, GameEventNoData.GameEventHandler listener)
//    {
//        GameEventBase e;
...
//    public static void AddListener<T>(EGameEvent eventType, GameEvent<T>.GameEventHandler listener) where T:class
//    {
//        GameEventBase e;
...
//    public static void RemoveListener<T>(EGameEvent eventType, GameEvent<T>.GameEventHandler listener) where T : class
//    {
//        GameEventBase e;
//        if (events.TryGetValue(eventType, out e) && (e is GameEvent<T>))
//        {
...
//    public static void Trigger<T>(EGameEvent eventType, T args) where T:class
//    {
//        GameEventBase e;
//        if (events.TryGetValue(eventType, out e) && (e is GameEvent<T>))
//        {
